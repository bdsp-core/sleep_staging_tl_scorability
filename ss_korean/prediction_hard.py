...
def predict(model_path, spec_path, sig_path, lab_path, fold):
    ...
    for i in range(0, len(test_line)):
        ...
        spec_path = '/bdsp/staging/BDSP-Sleep/CAISR/caisr_output/koges_robert_triple/stage/graph_2023_05_20_hard_samples/'
        os.makedirs(spec_path, exist_ok=True) 
...
def main():
        ...
        parser.add_argument('--model_path', type=str, default = '/home/ubuntu/snasiri/Stage/Models/graphsleepnet_ self-testing_SS_korean_triple_context_7_batch_10_atten_40_epoch_500/',
        help = 'signal path, default = /home/ubuntu/snasiri/Stage/Models/graphsleepnet_ self-testing_SS_korean_triple_context_7_batch_10_atten_40_epoch_500/')
        ...
        parser.add_argument('--spec_path', type=str, default = '/home/ubuntu/snasiri/CAISR_pred/gcn_ss/koges_robert_triple_Model_Hard_ONLY_20230520/',
        help = 'spec path, default = /home/ubuntu/snasiri/CAISR_pred/gcn_ss/koges_robert_triple_Model_Hard_ONLY_20230520/')
