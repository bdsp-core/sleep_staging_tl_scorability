...
def predict(model_path, spec_path, sig_path, lab_path, fold):
    ...
    removed_subjects = ['4720triple.h5', '4671triple.h5', '3567triple.h5', '3766triple.h5', '845triple.h5', '4611triple.h5', '852triple.h5']

    test_line = [x for x in test_line if x not in removed_subjects]
    ...
    for i in range(0, len(test_line)):
        ...
        spec_path = '/bdsp/staging/BDSP-Sleep/CAISR/caisr_output/koges_robert_triple/stage/koges_robert_triple_2023_09_05_with_folds/'
        os.makedirs(spec_path, exist_ok=True) 
...
def main():
        ...
        # parser.add_argument('--model_path', type=str, default = '/home/ubuntu/snasiri/Stage/Models/graphsleepnet_ self-testing_SS_korean_Triple_ALL_context_7_batch_10_atten_40_epoch_500/',
        # help = 'signal path, default = /home/ubuntu/snasiri/Stage/Models/graphsleepnet_ self-testing_SS_korean_Triple_ALL_context_7_batch_10_atten_40_epoch_500/')
        

        parser.add_argument('--model_path', type=str, default = '/home/ubuntu/snasiri/Stage/Models/graphsleepnet_ self-testing_SS_korean_triple_Sep4_23_context_7_batch_10_atten_40_epoch_300/',
        help = 'signal path, default = /home/ubuntu/snasiri/Stage/Models/graphsleepnet_ self-testing_SS_korean_triple_Sep4_23_context_7_batch_10_atten_40_epoch_300/')

        
        parser.add_argument('--spec_path', type=str, default = '/home/ubuntu/snasiri/CAISR_pred/gcn_ss/koges_robert_triple_20230518_base/',
        help = 'spec path, default = /home/ubuntu/snasiri/CAISR_pred/gcn_ss/koges_robert_triple_20230518_base/')
