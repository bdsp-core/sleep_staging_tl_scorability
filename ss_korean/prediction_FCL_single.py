...
def predict(model_path, spec_path, sig_path, lab_path, fold):
    ...
    fold = 2
    if fold == 1:
        df_sids_single_only = pd.read_csv(path_to_csv + 'single_koges_few_shot_fold_1.csv')
    if fold == 2:
        df_sids_single_only = pd.read_csv(path_to_csv + 'single_koges_few_shot_fold_2.csv')
    ...
    for i in range(0, len(test_line)):
        ...
        spec_path = '/bdsp/staging/BDSP-Sleep/CAISR/caisr_output/koges_robert_single/stage/koges_robert_single_FCL_fold_2_2023_10_30/'
        os.makedirs(spec_path, exist_ok=True) 
...
def main():
        ...
        # parser.add_argument('--model_path', type=str, default = '/home/ubuntu/snasiri/Stage/Models/graphsleepnet_context_7_batch_10_atten_40_epoch_1000/',
        # help = 'signal path, default = /home/ubuntu/snasiri/Stage/Models/graphsleepnet_context_7_batch_10_atten_40_epoch_1000/')

        parser.add_argument('--model_path', type=str, default = '/home/ubuntu/snasiri/koges_caisr/Stage/Models/graphsleepnet_ self-testing_SS_korean_FCL_fold_1_Oct17_single_context_7_batch_10_atten_40_epoch_70/',
        help = 'signal path, default = /home/ubuntu/snasiri/koges_caisr/Stage/Models/graphsleepnet_ self-testing_SS_korean_FCL_fold_1_Oct17_single_context_7_batch_10_atten_40_epoch_70/')
        
        
        parser.add_argument('--spec_path', type=str, default = '/home/ubuntu/snasiri/CAISR_pred/gcn_ss/koges_robert_single_FCL_fold_2_2023_10_17/',
        help = 'spec path, default = /home/ubuntu/snasiri/CAISR_pred/gcn_ss/koges_robert_single_FCL_fold_2_2023_10_17/')
