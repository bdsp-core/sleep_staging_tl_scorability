...
from train_ss_task_multi_cohort import *
...
def run(ifold, n, sig_path, lab_path, train_path):
    ...
    model_type = f'graphsleepnet_ multi-cohort_val_dice_SS_March_7_2024_context_{context}_batch_{batch_size}_atten_{attn_heads}_epoch_{num_epochs}'   # define model type: Note: modelName_...
    ...
    feature_folder = '/media/exx/Expansion1/CAISR/extracted_features/sleep_staging/'
