...
def predict(model_path, spec_path, sig_path, lab_path, fold):
    ...
    # path_to_csv = '/home/ubuntu/snasiri/CAISR/Sleep Staging/feature_extraction/'
    # fold = 1
    # if fold == 1:
    #     df_sids_single_only = pd.read_csv(path_to_csv + 'triple_few_shot_fold_1.csv')
    # if fold == 2:
    #     df_sids_single_only = pd.read_csv(path_to_csv + 'triple_few_shot_fold_2.csv')
    
    # test_line = df_sids_single_only['subjects'].values.tolist()
    ...
    for i in range(0, len(test_line)):
        ...
        # import pdb; pdb.set_trace()
        spec_path = '/bdsp/staging/BDSP-Sleep/CAISR/caisr_output/koges_prepared/stage/koges_robert_model_tunned_single_and_triple_subjects_2023_11_7/'
        os.makedirs(spec_path, exist_ok=True) 
...
def main():
        ...
        # parser.add_argument('--model_path', type=str, default = '/home/ubuntu/snasiri/koges_caisr/Stage/Models/graphsleepnet_ self-testing_SS_hard_subjects_koges_Oct30_context_7_batch_10_atten_40_epoch_20/',
        # help = 'signal path, default = /home/ubuntu/snasiri/koges_caisr/Stage/Models/graphsleepnet_ self-testing_SS_hard_subjects_koges_Oct30_context_7_batch_10_atten_40_epoch_20/')
        
        parser.add_argument('--model_path', type=str, default = '/home/ubuntu/snasiri/koges_caisr/Stage/Models/graphsleepnet_ self-testing_SS_koges_single_Nov7_2023_context_7_batch_10_atten_40_epoch_100/',
        help = 'signal path, default = /home/ubuntu/snasiri/koges_caisr/Stage/Models/graphsleepnet_ self-testing_SS_koges_single_Nov7_2023_context_7_batch_10_atten_40_epoch_100/')
        
        
        parser.add_argument('--spec_path', type=str, default = '/home/ubuntu/snasiri/CAISR_pred/gcn_ss/koges_robert_triple_model_tunned_with_all_single_scored_2023_10_17/',
        help = 'spec path, default = /home/ubuntu/snasiri/CAISR_pred/gcn_ss/koges_robert_triple_model_tunned_with_all_single_scored_2023_10_17/')
