...
def predict(model_path, spec_path, sig_path, lab_path, fold):
    ...
    for i in range(0, len(test_line)):
        ...
        spec_path = '/bdsp/staging/BDSP-Sleep/CAISR/caisr_output/koges_robert_triple/stage/graph_2023_05_20_Single_scored_NOT_base/'
        os.makedirs(spec_path, exist_ok=True) 
...
def main():
        ...
        parser.add_argument('--spec_path', type=str, default = '/home/ubuntu/snasiri/CAISR_pred/gcn_ss/koges_robert_triple_Model_single_ONLY_20230520/',
        help = 'spec path, default = /home/ubuntu/snasiri/CAISR_pred/gcn_ss/koges_robert_triple_Model_single_ONLY_20230520/')
