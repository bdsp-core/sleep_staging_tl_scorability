...
def predict(model_path, spec_path, sig_path, lab_path, fold):
    ...
    for i in range(0, len(test_line)):
        ...
        spec_path = '/media/exx/Expansion1/CAISR/caisr_output/stage/altitude_robert_graph_2024_01_29/'
        os.makedirs(spec_path, exist_ok=True) 
...
def main():
        ...
        parser.add_argument('--model_path', type=str, default = '/home/ubuntu/snasiri/Stage/Models/graphsleepnet_ self-testing_SS_korean_single_score_ONLY_context_7_batch_10_atten_40_epoch_500/',
        help = 'signal path, default = /home/ubuntu/snasiri/Stage/Models/graphsleepnet_ self-testing_SS_korean_single_score_ONLY_context_7_batch_10_atten_40_epoch_500/')
        
        parser.add_argument('--spec_path', type=str, default = '/home/ubuntu/snasiri/CAISR_pred/gcn_ss/koges_robert_20230530_final/',
        help = 'spec path, default = /home/ubuntu/snasiri/CAISR_pred/gcn_ss/koges_robert_20230530_final/')
